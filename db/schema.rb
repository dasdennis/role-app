...
ActiveRecord::Schema[8.1].define(version: 2026_06_18_142733) do
  ...
  create_table "availability_slots", force: :cascade do |t|
    ...
    t.index ["user_id", "day_of_week", "hour"], name: "idx_availability_slots_unique_per_user", unique: true
    ...
    t.check_constraint "hour >= 0 AND hour <= 23", name: "chk_valid_hour"
  end
